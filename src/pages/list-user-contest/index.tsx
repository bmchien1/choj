...
const UserContestList = () => {
  ...
  const { contents: publicContests = [], totalElements: totalPublicContests } =
    publicContestData || {};
  ...
  const {
    contents: registeredContests = [],
    totalElements: totalRegisteredContests,
  } = registeredContestData || {};
  ...
  const columns = [
    {
      ...
      render: (text: string, record: any) => (
        <div
          ...
          onClick={() => navigate(`/my-problems/${record.contestId}`)}
        >
          {text}
        </div>
      ),
